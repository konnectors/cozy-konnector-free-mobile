...
var getImageAndIdentifyNumbers = function(
    requiredFields,
    billInfos,
    data,
    next
    ...
    return async.map(urlAndPosition, getImageAndIdentifyNumber, function(
        err,
        results
    ) {
        if (err != null) {
...
var logIn = function(requiredFields, billInfos, data, next) {
    ...
    let transcodedLogin = transcodeLogin(
    ...
    return async.eachSeries(uniqueLogin, getSmallImage(timerDownload), function(
        err
    ) {
        if (err != null) {
            return next(err)
...
var getSmallImage = function(timer) {
